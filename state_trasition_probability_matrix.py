# -*- coding: utf-8 -*-
"""State_trasition probability_matrix.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13soTlYMw9RF1kSTuQVoHdhS9WzWNpSta
"""
...
class Node():
    def __init__(
        ...
        facecolor='#bb9351', edgecolor='#e6e6e6',
...
class MarkovChain:
    def __init__(self, M, labels):
        ...
        if M.shape[0] != 6:
            raise Exception("Only works with 6 states max for now")
    ...
    def set_node_centers(self):
        ...
        self.xlim = (-5, 5)
        self.ylim = (-5, 5)
        self.node_centers = [[0,4],[4,2],[4,-2],[0,-4],[-4,-2],[-4,2]]
...
mydata= pd.read_excel(r"crop_rotation_data.xlsx")
workingData = mydata.drop(columns = ['Year'])
transitions= []
cols=35
rows=68
for i in range(1,cols+1):
    for j in workingData[i]:
...
mc = MarkovChain(np.round(M,3), ['Wheat', 'Barley','Peas','Pasture','Oats','Fallow'])
mc.draw()

# W = Wheat, P = Pasture, Pe = peas, B= Barley, O = Oats, F = Fallow